...
/* Configure the peripherals common clocks */
  ...
  while (1)
  {
		if(DMA_ADC_Enable_Flag==1)
		{
			DMA_ADC_TIM_Enable();
		}
		if(USB_Transfer_Enable_Flag==1)
		{
			usb_sendHalfwords(ADC_Value_Buffer, UserTxBufferHS, ADC_BUFFER_SIZE, &USB_Transfer_Enable_Flag,1);
		}
		LL_mDelay(10);
    /* USER CODE END WHILE */
